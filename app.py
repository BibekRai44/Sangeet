...
def recommend_similar_artists(artist_name, df, top_n=3):
    ...
    input_genre = input_artist_info['Genres']
    
    similar_genre_artists = df[df['Genres'] == input_genre]

    similar_artists = similar_genre_artists[similar_genre_artists['Artist Name'].str.lower() != artist_name]
    
    similar_artists = similar_artists.head(top_n)
